...
declare const DateFilter: <T extends DateFilterProps = DateFilterProps>({ timezone, canResetFilters, defaultParams, filters, nowTimestamp, refreshNowTimestamp, sinceDate, untilDate, updateFilters, }: Pick<T, "sinceDate" | "untilDate"> & DataOverviewDateFilterProps) => import("preact").JSX.Element;
