...
export declare const CARD_SUBTITLE = "adyen-pe-card__subtitle";
export declare const CARD_HEADER_CONTENT = "adyen-pe-card__header-content";
export declare const CARD_BODY_WITH_TITLE = "adyen-pe-card__body--with-title";
export declare const CARD_NO_OUTLINE = "adyen-pe-card--no-outline";
