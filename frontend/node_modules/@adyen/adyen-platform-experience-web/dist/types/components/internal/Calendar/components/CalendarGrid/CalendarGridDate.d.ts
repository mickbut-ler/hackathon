declare const _default: (props: Readonly<{
    ...
    onlyCellsWithin: import("./types").CalendarGridProps["onlyCellsWithin"];
    row: number;
} & Pick<import("./types").CalendarGridProps, "grid" | "prepare"> & {
    block: import("../../calendar/types").CalendarGrid[number];
    cell: number;
} & {
