...
export declare const CapitalOfferSelection: ({ dynamicOffersConfig, dynamicOffersConfigError, emptyGrantOffer, onContactSupport, onOfferDismiss, onOfferSelect, requestedAmount, }: CapitalOfferSelectionProps) => import("preact").JSX.Element;
export {};
//# sourceMappingURL=CapitalOfferSelection.d.ts.map