...
export declare const isFunction: <T>(value?: T) => value is GetPredicateType<(...args: any[]) => any, T>;
export declare const isNull: (value?: any) => value is null;
export declare const isNullish: (value?: any) => value is undefined | null;
export declare const isNumber: (value?: any) => value is number;
export declare const isPlainObject: <T>(value?: T) => value is GetPredicateType<Record<any, any>, T>;
